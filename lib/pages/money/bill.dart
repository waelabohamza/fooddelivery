...
class _BillState extends State<Bill> {
    ...
    return Scaffold(
      body: Container(
        ...
        Container(
          ...
          Divider(),
          buildCardTopRow(
              "الرصيد الكلي", " ${sharedPrefs.getString("balance")} KWD"),
          Divider(),
          buildCardTopRow(
              "الرصيد المتاح", " ${sharedPrefs.getString("balance")} KWD "),
        ]))),
        buildContainerDay(),
        Container(
          padding: EdgeInsets.symmetric(horizontal: 20 , vertical: 10),
          child: Row(children: [
             Text("التاريخ" ,style: Theme.of(context).textTheme.bodyText1, )  , 
             Spacer()  , 
             Text("التفاصيل",style: Theme.of(context).textTheme.bodyText1)  , 
             Spacer()  , 
  ...
  Container buildContainerDay() {
    TextStyle daystyle = TextStyle(color: Colors.brown, fontFamily: "Cairo"  , fontWeight: FontWeight.bold);
